...
@dataclass
class ClassInfo:
    """Represents a single Java class / interface / enum."""
    name: str
...
# ═══════════════════════════════════════════════════════════════════════
#  LEGACY MODELS (kept for backward compat with old analyzer)
# ═══════════════════════════════════════════════════════════════════════
...
@dataclass
class Documentation:
    """Full documentation for one class."""
    class_info: ClassInfo
